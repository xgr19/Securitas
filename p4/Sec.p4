    ...
    inout ingress_intrinsic_metadata_for_tm_t        ig_tm_md)
{
    ...
    table assign_patch_info{
        ...
        actions = {ac_should_TTL; ac_should_fragment; 
            ac_jump_deparser;}
        // ISCX_204.p4 is generated by web_securitas_training/generate_p4.py and copied into this directory.
    ...
    apply{
        // Rename PARSER_ERROR_NO_TCAM to PARSER_ERROR_NO_MATCH  ref: https://github.com/barefootnetworks/Open-Tofino/blob/master/share/p4c/p4include/tofino1_base.p4
        if(ig_prsr_md.parser_err == PARSER_ERROR_NO_TCAM){ droppacket(); }
        ...
        if (hdr.ipv4.ihl == 5){ // in 4-byte unit
            ...
            // meta.pkt_cnt = meta.pkt_cnt & 0b0000011111111111;  // Keep 11 of 16 bits, giving 2048; WF has 800 elements, patch 40%.
            meta.pkt_cnt = meta.pkt_cnt & 0b0000000111111111;  // Keep 9 of 16 bits, giving 2048; ISCX has 204 elements, patch 40%.
    ...
    inout egress_intrinsic_metadata_for_output_port_t  eg_oport_md)
{
    ...
    apply {
        // Rename PARSER_ERROR_NO_TCAM to PARSER_ERROR_NO_MATCH  ref: https://github.com/barefootnetworks/Open-Tofino/blob/master/share/p4c/p4include/tofino1_base.p4
        if(eg_prsr_md.parser_err == PARSER_ERROR_NO_TCAM){ droppacket(); }
